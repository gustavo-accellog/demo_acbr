...
public final class ACBrNFe extends ACBrLibBase implements AutoCloseable {
	...
	public void configGravarValor(ACBrSessao eSessao, String eChave, Object value) throws Exception {
		int ret = ACBrNFeLib.INSTANCE.NFE_ConfigGravarValor(toUTF8(eSessao.name()), toUTF8(eChave),
				toUTF8(value.toString()));
		checkResult(ret);
	}
	...
	public String inutilizar(String aCNPJ, String aJustificativa, int ano, int modelo, int serie, int numeroInicial,
			int numeroFinal) throws Exception {
		ByteBuffer buffer = ByteBuffer.allocate(STR_BUFFER_LEN);
		IntByReference bufferLen = new IntByReference(STR_BUFFER_LEN);
	...
	public String cancelar(String aChave, String aJustificativa, String aCNPJ, int aLote) throws Exception {
		...
		int ret = ACBrNFeLib.INSTANCE.NFE_Cancelar(toUTF8(aChave), toUTF8(aJustificativa), toUTF8(aCNPJ), aLote, buffer,
				bufferLen);
		checkResult(ret);
	...
	public String distribuicaoDFeporUltNSU(int acUFAutor, String aCNPJCPF, String eultNsu) throws Exception {
		...
		int ret = ACBrNFeLib.INSTANCE.NFE_DistribuicaoDFePorUltNSU(acUFAutor, toUTF8(aCNPJCPF), toUTF8(eultNsu), buffer,
				bufferLen);
		checkResult(ret);
	...
	public String distribuicaoDFeporNSU(int acUFAutor, String aCNPJCPF, String aNSU) throws Exception {
		...
		int ret = ACBrNFeLib.INSTANCE.NFE_DistribuicaoDFePorNSU(acUFAutor, toUTF8(aCNPJCPF), toUTF8(aNSU), buffer,
				bufferLen);
		checkResult(ret);
	...
	public void enviarEmail(String aPara, String aChaveNFe, boolean aEnviarPDF, String aAssunto, String aEmailCC,
			String aAnexos, String aMesagem) throws Exception {
		int ret = ACBrNFeLib.INSTANCE.NFE_EnviarEmail(aPara, aChaveNFe, aEnviarPDF, aAssunto, aEmailCC, aAnexos,
				aMesagem);
		checkResult(ret);
	}
	...
	public void enviarEmailEvento(String aPara, String aChaveEvento, String aChaveNFe, boolean aEnviarPDF,
		...
		int ret = ACBrNFeLib.INSTANCE.NFE_EnviarEmailEvento(aPara, aChaveEvento, aChaveNFe, aEnviarPDF, aAssunto,
	...
	public void imprimir(String cImpressora, int nNumCopias, String cProtocolo, Boolean bMostrarPreview,
			Boolean cMarcaDagua, Boolean bViaConsumidor, Boolean bSimplificado) throws Exception {
		...
		int ret = ACBrNFeLib.INSTANCE.NFE_Imprimir(toUTF8(cImpressora), nNumCopias, toUTF8(cProtocolo),
				toUTF8(mostrarPreview), toUTF8(marcaDagua), toUTF8(viaConsumidor), toUTF8(simplificado));
		checkResult(ret);
	}
